...
if($result){
    while($row = mysqli_fetch_assoc($result)){
        ...
        <td> '.$name.'</td>
          ...
          <button id="delete" ><a onclick="checker()" href="delete.php?deletename='.$name.'">Delete</a></button></td>
              <td><button id="book"><a href="admission.php?admission='.$id.'">Allot Bed </a></button></td>
          </tr>';
    }
}
?>
