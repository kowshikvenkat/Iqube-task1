...
<tr style="border:5px solid red"><th></th>
<th></th>
<th>ICU WARD</th>
<th></th>
<th></th>
...
<td></td>
<td></td>
<td><i id="FLOOR-1 ICUw 1"  class="fas fa-bed"><br>
...
<td></td>
<td></td>
<td><i id="FLOOR-2 ICUw 1"  class="fas fa-bed"><br>
...
if(strpos($rooms,$ICU)!==false){
      echo   '<script type="text/javascript">';
      echo 'var result = confirm("Are you sure to allot the patient in ICU ward?");
        if(result==false){';
...
if($resultii){
       echo "<script>alert('Bed removed');</script>";
}
}else{
